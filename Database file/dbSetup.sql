...
VALUES
    ...
    ('Movie_images/AoaF.jpg','Anatomy of a Fall','{"Sandra Huller", "Swann Arlaud", "Milo Machado-Graner"}','A woman is suspected of murder after her husband''s death; their half-blind son faces a moral dilemma as the main witness.','{"Crime","Drama","Thriller"}','{"Amazon"}','2h 31m','https://www.youtube.com/embed/FUXawkH-ONM?si=uPLPEc3RJCmgKL1f' ),
    ('Movie_images/TheHoldovers.jpg','The Holdovers', '{"Paul Giamatti", "Da''Vine Joy Randolph", "Dominic Sessa"}','A cranky history teacher at a prep school is forced to remain on campus over the holidays with a grieving cook and a troubled student who has no place to go.','{"Drama","Comedy"}','{"Peacock","Amazon"}','2h 13m','https://www.youtube.com/embed/AhKLpJmHhIg?si=eZhJglv5FjZnwskH'),
    ('Movie_images/MayDecember.jpg','May December','{"Natalie Portman","Chris Tenzis","Charles Melton"}','Twenty years after their notorious tabloid romance gripped the nation, a married couple buckles under pressure when an actress arrives to do research for a film about their past.','{"Comedy","Drama"}','{"Netflix"}','1h 57m','https://www.youtube.com/embed/BBKb1WoXokc?si=98HY-qczv5hB8Jf3'),
    ('Movie_images/AmericanFiction.jpg','American Fiction','{"Jeffrey Wright","tracee Ellis Ross"," John Ortiz"}','A novelist who''s fed up with the establishment profiting from Black entertainment uses a pen name to write a book that propels him into the heart of the hypocrisy and madness he claims to disdain.','{"Drama","Comedy"}', '{"Amazon"}', '1h 57m','https://www.youtube.com/embed/i0MbLCpYJPA?si=fM_Y083QT0nlFtYz'),
    ('Movie_images/Beau.jpg','Beau Is Afraid', '{"Joaquin Pheonix","Patti LuPone","Amy Ryan"}','Following the sudden death of his mother, a mild-mannered but anxiety-ridden man confronts his darkest fears as he embarks on an epic, Kafkaesque odyssey back home.','{"Comedy","Horror","Drama"}','{"Paramount","Amazon"}','2h 59m','https://www.youtube.com/watch?v=kGBM7sJDulw&pp=ygUaYmVhdSBvcyBhZnJhaWQgcmFpbGVyIDIwMjQ%3D');
...
VALUES
    ...
    ('show_images/teen_titans.jpg', 'Teen Titans','{Scott Menville, Hynden Walch, Greg Cipes}','A team of five teenaged superheroes save the world from many villains around their city while experiencing things normal teens face today.', '{Action, Adventure, Sci-Fi}', '{Amazon, HBO Max}', '8 hours','https://www.youtube.com/embed/RrHPnPAHE1A?si=xdYw10_GVThGWcac'),
    ...
    ('show_images/ben10.jpg', 'Ben 10','{Tara Strong, Meagan Moore, Paul Eiding}','The story of Ben Tennyson, a typical kid who becomes very atypical after he discovers the Omnitrix, a mysterious alien device with the power to transform the wearer into ten different alien species.', '{Action, Sci-Fi, Adventure}', '{Amazon}', '10 hours','https://www.youtube.com/watch?v=n-7PFiut1HI'),
