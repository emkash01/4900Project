...
VALUES
    ('Movie_images/Oppenheimer_(film).jpg', 'Oppenheimer', '{"Cillian Murphy"}', 'A biographical film about J. Robert Oppenheimer and his role in the development of the atomic bomb.', '{"Biography", "Drama", "History"}', '{"Theatrical Release"}', '2h 30m', 'https://trailer_link_for_oppenheimer.com'),
    ('Movie_images/CACivilWar.jpg', 'Captain America: Civil War', '{"Chris Evans", "Robert Downey Jr."}', 'Political interference in the Avengers activities causes a rift between former allies Captain America and Iron Man.', '{"Action", "Adventure", "Superhero"}', '{"Theatrical Release"}', '2h 27m', 'https://trailer_link_for_captain_america_civil_war.com'),
    ('Movie_images/HTTYD3.jpg', 'How to Train Your Dragon: The Hidden World', '{"Jay Baruchel", "America Ferrera"}', 'When Hiccup discovers Toothless is not the only Night Fury, he must seek "The Hidden World", a secret Dragon Utopia before a hired tyrant finds it first.', '{"Animation", "Adventure", "Family"}', '{"Theatrical Release"}', '1h 44m', 'https://trailer_link_for_how_to_train_your_dragon_hidden_world.com'),
    ('Movie_images/Deadpool3.jpg', 'Deadpool 3', '{"Ryan Reynolds"}', 'In the third installment of the Deadpool franchise, the irreverent mercenary Deadpool brings his unique brand of justice and humor back to the screen.', '{"Action", "Comedy", "Superhero"}', '{"Theatrical Release"}', '2h 10m', 'https://trailer_link_for_deadpool_3.com'),
    ('Movie_images/MadameWeb.jpg', 'Madame Web', '{"Dakota Johnson"}', 'Madame Web, a clairvoyant mutant who can see within the spider world, gets her own story.', '{"Action", "Adventure", "Superhero"}', '{"Theatrical Release"}', '2h 15m', 'https://trailer_link_for_madame_web.com');
